...
public class OpenedFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
  ...
  private void prepareCarData(String paramString) {
    ...
    progressDialog.show();
    ApiModule.getAPIService().getOpenedCarList(rollId, userId, token).enqueue(new Callback<ResultList>() {
          ...
          public void onResponse(Call<ResultList> param1Call, Response<ResultList> param1Response)
          {
            mSwipeRefreshLayout.setRefreshing(false);
